...
let books = [
  ...
  // Route 1 - response to GET request
  app.get('/books', (req, res) => {
    res.json(books); // Send the array of books as JSON response
 });

 // Route 2 - response to POST request
...
// Route 3 - response to GET request with a parameter
...
// Route 4 - response to PUT request
...
// Route 5 - response to a DELETE request
